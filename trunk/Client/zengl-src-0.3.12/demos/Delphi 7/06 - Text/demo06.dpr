...
begin
  ...
  // CN: 如果纹理未使用--"字体名称-page序号.后缀名"格式来载入 使用一下方法来载入(PNG图片字体);
...
begin
  ...
  // CN: ZenGL 使用UTF-8编码 所以所有字体都应该使用UTF-8来编码。如果你想使用一些文本(非英文)保存在pas文件内 并且delphi的版本低于2009,
  //    那么需要使用外部UTF-8编码文件使用UTF8-String来读取
