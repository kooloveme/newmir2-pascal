...
procedure CompressBuffer(const InData: Pointer; InSize: LongInt; out OutData:
  Pointer; out OutSize: LongInt);
procedure UnCompressBuffer(const InData: Pointer; InSize: LongInt; out OutData:
  Pointer; out OutSize: LongInt);

procedure CompressBufferL(const InData: Pointer; InSize: LongInt; out OutData:
  Pointer; out OutSize: LongInt);
procedure UnCompressBufferL(const InData: Pointer; InSize: LongInt; out OutData:
  Pointer; out OutSize: LongInt);

function Compression(Source, Dest: BufferPtr; SourceSize: BufferSize):
  BufferSize;
function Decompression(Source, Dest: BufferPtr; SourceSize: BufferSize):
  BufferSize;
...
begin
  ...
  while InSize > 0 do
  begin
    if InSize > SizeOf(BufferArray) then
    begin
