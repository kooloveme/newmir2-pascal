...
{*}
function ArrestStringEx(Source: string; SearchAfter, ArrestBefore: Char; var
  ArrestStr: string): string;
function ArrestStringEx2(Source: string; SearchAfter, ArrestBefore: Char; var
  ArrestStr: string): string;
...
function FastCharPos(const aSource: string; const C: Char; StartPos: Integer):
  Integer;
var
  L: Integer;
begin
